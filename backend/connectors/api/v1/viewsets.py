...
class Testconnectors136369ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS136369_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS136369_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS136369"
